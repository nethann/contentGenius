      ...
      <div className="auth-wrapper">
        ...
        <div className="auth-card">
          ...
          {localError && (
            <div className="auth-error">
              ...
              <div>
                <p className="auth-error-title">Sign in failed</p>
          ...
          <div className="auth-alternative">
            <p className="text-center text-gray-400">
              ...
              <Link to="/signup" className="auth-switch-link ml-1">
                Try email signup
              </Link>
            </p>
          </div>
        ...
        <div className="auth-features">
          <div className="auth-feature">
            <p className="auth-feature-title">✨ AI-Powered</p>
            <p className="auth-feature-description">Smart content analysis</p>
          </div>
          <div className="auth-feature">
            <p className="auth-feature-title">🚀 Viral Ready</p>
            <p className="auth-feature-description">Attention-grabbing clips</p>
          </div>
        </div>
      </div>
    </div>
